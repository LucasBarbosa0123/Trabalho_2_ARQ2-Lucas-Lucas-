    ...
    while(true)
    {
        ...
        else if(ord[0].at(0) == 'B')
        {
            ...
            if(flag_mode == 1){
                ...
                printf("Statico\n");
                ptrs[pos]->prediction = statico.predict();
            }else if(flag_mode == 3){
                printf("Statico not\n");
                ptrs[pos]->prediction = statico_not.predict();
            }
            else{
                printf("BPB\n");
        ...
        switch(rob_buff[0]->instruction.at(0)){
            ...
            case 'B':
                ...
                if(flag_mode == 1){
                    ...
                    printf("FOIIIII 4");
                    statico.update_state(hit);
                }else if(flag_mode == 3){
                    printf("FOIIIII 4");
                    statico_not.update_state(hit);
                }
                else{
...
static_taken reorder_buffer::get_taken(){
    return statico;
}

static_not_taken reorder_buffer::get_not_taken(){
    return statico_not;
}
